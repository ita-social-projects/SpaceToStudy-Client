/*! For license information please see 10.cca49323.iframe.bundle.js.LICENSE.txt */
;(window.webpackJsonp = window.webpackJsonp || []).push([
  [10],
  {
    './node_modules/@storybook/components/dist/esm/OverlayScrollbars-26c4a78d.js': function (
      module,
      __webpack_exports__,
      __webpack_require__
    ) {
      ...
      var _index_b45716e8_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
          './node_modules/@storybook/components/dist/esm/index-b45716e8.js'
        ),
        react__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__('./node_modules/react/index.js'),
        react__WEBPACK_IMPORTED_MODULE_23___default = __webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_23__)
      ...
      !(function (module) {
        var global
        ;(global = 'undefined' != typeof window ? window : _index_b45716e8_js__WEBPACK_IMPORTED_MODULE_22__.H),
            ...
            var _targets,
                  ...
                  _jsAPI: function _jsAPI(name, isInterface, fallback) {
                    ...
                    if (!jsCache[LEXICON.hOP](name)) {
                      for (result = window[name]; i < jsPrefixes[LEXICON.l]; i++)
                        result =
                          result ||
                          window[(isInterface ? jsPrefixes[i] : jsPrefixes[i].toLowerCase()) + firstLetterToUpper(name)]
                      jsCache[name] = result
                    }
                ...
                return {
                  ...
                  page: function page(event) {
                    var strPage = 'page',
                      ...
                      strY = 'Y',
                      eventDoc =
                        ((event = event.originalEvent || event).target || event.srcElement || document).ownerDocument ||
                        document,
              ...
              FRAMEWORK = (function () {
                ...
                function isArrayLike(obj) {
                  ...
                  return (
                    !isFunction(t) &&
                    (t == TYPES.a || 0 === length || (_type(length) == TYPES.n && length > 0 && length - 1 in obj))
                  )
                }
                ...
                function setCSSVal(el, prop, val) {
                  try {
                    el[LEXICON.s][prop] !== undefined$1 && (el[LEXICON.s][prop] = parseCSSVal(prop, val))
                  } catch (e) {}
                }
                  ...
                  !1 !== removeFromQ && animObj.q.splice(0, 1),
                    animObj.q[LEXICON.l] > 0
                      ? ((nextAnim = animObj.q[0]),
                        _animate(animObj.el, nextAnim.props, nextAnim.duration, nextAnim.easing, nextAnim.complete, !0))
                ...
                function _animate(el, props, options, easing, complete, guaranteedNext) {
                  ...
                  for (key in from) from[key] !== props[key] && props[key] !== undefined$1 && (to[key] = props[key])
                          ...
                          (_frame = function frame() {
                            ...
                            to))
                              (fromVal = parseFloat(from[key])),
                                ...
                                (easedVal =
                                  (toVal - fromVal) *
                                    EASING[specialEasing[key] || easing](percent, percent * duration, 0, 1, duration) +
                                  fromVal),
                ...
                return (
                  (FakejQuery[LEXICON.p] = {
                    on: function on(eventName, handler) {
                      var el,
                        eventNameLength = (eventName = (eventName || _strEmpty).match(_rnothtmlwhite) || [_strEmpty])[
                          LEXICON.l
                        ],
                        i = 0
                    ...
                    hasClass: function hasClass(className) {
                      for (
                        var elem, classList, i = 0, classNamePrepared = _strSpace + className + _strSpace;
                        (elem = this[i++]);
                        ...
                        if (
                          1 === elem.nodeType &&
                          (_strSpace + stripAndCollapse(elem.className + _strEmpty) + _strSpace).indexOf(
                            classNamePrepared
                          ) > -1
                        )
                          return !0
                      ...
                      if (className)
                        for (classes = className.match(_rnothtmlwhite) || []; (elem = this[i++]); )
                          if (
                            ...
                            supportClassList === undefined$1 && (supportClassList = elmClassList !== undefined$1),
                            supportClassList)
                          )
              ...
              PLUGIN = (function () {
                    ...
                    (_base.remove = function (instance) {
                      ...
                      index > -1 &&
                        ...
                        0 === _loopingInstances[_strLength] &&
                          ...
                          _loopID !== undefined$1 && (COMPATIBILITY.cAF()(_loopID), (_loopID = -1))))
                    })
                }
                function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
                  ...
                  if (isHTMLElement(pluginTargetElement)) {
                    ...
                    var _nativeScrollbarIsOverlaid,
                      ...
                      _classNameHostScrollbarHorizontalHidden =
                        _classNameHostElement + '-' + _strScrollbar + _strMinusHorizontal + _strMinusHidden,
                      _classNameHostScrollbarVerticalHidden =
                        _classNameHostElement + '-' + _strScrollbar + _strMinusVertical + _strMinusHidden,
                    ...
                    return (
                      ...
                      (_base.scroll = function (coordinates, duration, easing, complete) {
                        ...
                        function checkSettingsStringValue(currValue, allowedValues) {
                          for (i = 0; i < allowedValues[strLength]; i++) if (currValue === allowedValues[i]) return !0
                          return !1
                        }
                            ...
                            (isString
                              ? (rawScroll[strLength] > 2 &&
                                ...
                                (rawScroll = (rawScroll = operator ? rawScroll.substr(2) : rawScroll)
                                  ...
                                  [strReplace](
                                    /%/g,
                                    mult + (maxScroll * (isRTLisX && _rtlScrollBehavior.n ? -1 : 1)) / 100
                                  )
                          ...
                          for (
                            ...
                            (currValue = marginTopRightBottomLeftArray[i]),
                              (currValueType = type(currValue)) == TYPES.b
                                ? result.push(
                                    currValue
                                      ? parseToZeroOrNumber(finalElement.css(_strMarginMinus + valueDirections[i]))
                                      : 0
                                  )
                              ...
                              (_isRTL &&
                                (_rtlScrollBehavior.n ||
                                  ...
                                  (elementScrollCoordinates.x = MATH.round(
                                    viewportOffset[_strLeft] - elementOffset[_strLeft] + viewportScroll.l
                                  )),
                              ...
                              var measuringElm = finalElement[0],
                                ...
                                finalizeBlock = function finalizeBlock(isX) {
                                  var vars = getScrollbarVars(isX),
                                    ...
                                    isInView =
                                      elSize <= vpSize && elOffset >= vpOffset && elOffset + elSize <= vpOffset + vpSize
                                  scrollNever
                                    ? (doNotScroll[xy] = !0)
                                    : doNotScroll[xy] ||
                        ...
                        if (registeredExtensionObj) {
                          ...
                          if (
                            ...
                            type(instanceContract) == TYPES.f &&
                              ...
                              (contractFulfilled =
                                type(contractResult) == TYPES.b ? contractResult : contractFulfilled)),
                            contractFulfilled)
                          )
                            return (
                  ...
                  function addDestroyEventListener(element, eventNames, listener, passive) {
                    setupResponsiveEventListener(element, eventNames, listener, !1, passive),
                      _destroyEvents.push(
                        COMPATIBILITY.bind(setupResponsiveEventListener, 0, element, eventNames, listener, !0, passive)
                      )
                  }
                      ...
                      if (onElementResizedCallback) {
                        if (_supportResizeObserver)
                          ((element = targetElement
                            ...
                            .contents()[0])[_strResizeObserverProperty] = new resizeObserver(callback)).observe(element)
                          ...
                          if (attachEvent)
                            targetElement.prepend(generateDiv(_classNameResizeObserverElement)),
                              findFirst(targetElement, _strDot + _classNameResizeObserverElement)[0].attachEvent(
                                'onresize',
                                callback
                              )
                          else {
                        ...
                        if (targetElement[0] === _sizeObserverElementNative) {
                          ...
                          directionChanged(),
                            addDestroyEventListener(targetElement, _strScroll, function (event) {
                              return (
                                directionChanged() && update(), COMPATIBILITY.prvD(event), COMPATIBILITY.stpP(event), !1
                              )
                            })
                        }
                        ...
                        resizeObserverObj &&
                          (resizeObserverObj.disconnect(), delete element[_strResizeObserverProperty])
                  ...
                  function hostClassNamesChanged(oldClassNames, newClassNames) {
                    var i,
                      regex,
                      currClasses = _typeof(newClassNames) == TYPES.s ? newClassNames.split(_strSpace) : [],
                  ...
                  function updateAutoContentSizeChanged() {
                    ...
                    return (
                      ...
                      setCSS &&
                        ((css[_strFloat] = float), (css[_strWidth] = _strHundredPercent), _contentElement.css(css)),
                    ...
                    if (!_sleeping && !_mutationObserversConnected) {
                      var elem,
                        ...
                        checks = [
                          ...
                          { _elem: _isTextarea ? _targetElement : undefined$1, _attrs: _mutationObserverAttrsTextarea }
                        ]
                      return (
                  ...
                  function update(updateHints) {
                    ...
                    if (
                      ...
                      var checkCacheAutoForce = function checkCacheAutoForce() {
                        ...
                        overflowBehaviorChanged = checkCacheAutoForce(overflowBehavior, _overflowBehaviorCache, force),
                      ...
                      if (
                        ...
                        (ignoreOverlayScrollbarHiding =
                          ignoreOverlayScrollbarHiding && _nativeScrollbarIsOverlaid.x && _nativeScrollbarIsOverlaid.y),
                      ...
                      force &&
                        ...
                        (displayIsHidden =
                          displayIsHidden === undefined$1 ? _hostElement.is(':hidden') : displayIsHidden)
                      ...
                      if (
                        ...
                        widthAuto
                          ? ((contentGlueElementCSS[_strWidth] = _strAuto),
                            (contentElementCSS[_strWidth] =
                              VENDORS._cssPropertyValue(_strWidth, 'max-content intrinsic') || _strAuto),
                        ...
                        if (
                          ...
                          var textareaCoverCSS = {},
                            setContentGlueElementCSSfunction = function setContentGlueElementCSSfunction(horizontal) {
                        ...
                        var hideOverflowForceTextarea = _isTextarea && (0 === _viewportSize.w || 0 === _viewportSize.h),
                        ...
                        if (
                          ...
                          ;(hasOverflow.x || hasOverflow.y) &&
                            ...
                            ignoreOverlayScrollbarHiding &&
                              ((arrangeContent.w = arrangeContent.h = _strEmpty), (arrangeChanged = !0)),
                            arrangeChanged &&
                              !_nativeScrollbarStyling &&
                          ...
                          if (_isRTL && widthAuto) {
                            var floatTmp = _contentElement.css(_strFloat),
                              posLeftWithoutFloat = MATH.round(
                                _contentElement.css(_strFloat, _strEmpty).css(_strLeft, _strEmpty).position().left
                              )
                        ...
                        if ((_contentElement.css(contentElementCSS), _isTextarea && contentSizeChanged)) {
                          ...
                          if (textareaInfo) {
                            var textareaRowsChanged =
                                _textareaInfoCache === undefined$1 || textareaInfo._rows !== _textareaInfoCache._rows,
                        ...
                        var scrollbarsVisibilityVisible = 'v' === scrollbarsVisibility,
                          ...
                          refreshScrollbarsVisibility = function refreshScrollbarsVisibility(showX, showY) {
                        ...
                        addRemoveClass(_hostElement, _classNameHostOverflow, hideOverflow.x || hideOverflow.y),
                          ...
                          scrollbarsClickScrollingChanged && refreshScrollbarsInteractive(!0, scrollbarsClickScrolling),
                  ...
                  function setupStructureDOM(destroy) {
                    ...
                    ;(_hostElement =
                      ...
                      (_isTextarea
                        ...
                        : _targetElement)),
                      (_contentElement =
                        _contentElement || selectOrGenerateDivByClass(_classNameContentElement + textareaClass)),
                      (_viewportElement =
                        _viewportElement || selectOrGenerateDivByClass(_classNameViewportElement + textareaClass)),
                      (_paddingElement =
                        _paddingElement || selectOrGenerateDivByClass(_classNamePaddingElement + textareaClass)),
                      (_sizeObserverElement =
                        _sizeObserverElement || selectOrGenerateDivByClass(classNameResizeObserverHost)),
                      (_textareaCoverElement =
                        _textareaCoverElement ||
                        (_isTextarea ? selectOrGenerateDivByClass(_classNameTextareaCoverElement) : undefined$1)),
                  ...
                  function setupScrollbarsDOM(destroy) {
                    var horizontalElements,
                      verticalElements,
                      selectOrGenerateScrollbarDOM = function selectOrGenerateScrollbarDOM(isHorizontal) {
                        var scrollbar = selectOrGenerateDivByClass(
                            _classNameScrollbar +
                              _strSpace +
                              (isHorizontal ? _classNameScrollbarHorizontal : _classNameScrollbarVertical),
                            !0
                          ),
                  ...
                  function setupScrollbarEvents(isHorizontal) {
                    ...
                    function documentMouseTouchUp(event) {
                      if (
                        ...
                        COMPATIBILITY.rAF()(function () {
                          setupResponsiveEventListener(_documentElement, strClickEvent, stopClickEventPropagation, !0, {
                            _capture: !0
                          })
                        }),
                        ...
                        trackTimeout !== undefined$1 &&
                          (_base.scrollStop(), clearTimeout(trackTimeout), (trackTimeout = undefined$1)),
                        event)
                      ) {
                    ...
                    function onHandleMouseTouchDownAction(event) {
                      ;(mouseDownScroll = _viewportElement[scroll]()),
                        ...
                        COMPATIBILITY.rAF()(function () {
                          setupResponsiveEventListener(_documentElement, strClickEvent, stopClickEventPropagation, !1, {
                            _capture: !0
                          })
                        }),
                            ...
                            if (!_destroyed) {
                              var mouseOffset = (mouseDownOffset - trackOffset) * mouseDownInvertedScale,
                                ...
                                instantScrollPosition =
                                  scrollRange * ((mouseOffset - handleLength / 2) / (trackLength - handleLength)),
                                rtlIsNormal =
                                  _isRTL &&
                                  isHorizontal &&
                  ...
                  function refreshScrollbarHandleOffset(isHorizontal, scrollOrTransition) {
                    var transformOffset,
                      ...
                      currentScroll =
                        scrollOrTransition === undefined$1 || transition ? nativeScroll : scrollOrTransition,
                      handleLength = scrollbarVarsInfo._handleLength,
                  ...
                  function setupScrollbarCornerDOM(destroy) {
                    ;(_scrollbarCornerElement =
                      _scrollbarCornerElement || selectOrGenerateDivByClass(_classNameScrollbarCorner, !0)),
                      destroy
                        ? _domExists && _initialized
                  ...
                  function setupScrollbarCornerEvents() {
                      ...
                      if (onMouseTouchDownContinue(event)) {
                        ...
                        ;(_resizeHorizontal || _resizeBoth) &&
                          (hostElementCSS[_strWidth] =
                            mouseDownSize.w + (pageOffset.x - mouseDownPosition.x) * mouseDownInvertedScale.x),
                    ...
                    function documentMouseTouchUp(event) {
                      ...
                      setupResponsiveEventListener(
                        ...
                        eventIsTrusted &&
                          (reconnectMutationObserver && connectMutationObservers(), _base.update(_strAuto)),
                  ...
                  function isHTMLElement(o) {
                    ...
                    return _typeof(wnd[strHTMLElement]) == TYPES.o
                      ...
                      : o && _typeof(o) == TYPES.o && null !== o && 1 === o.nodeType && _typeof(o.nodeName) == TYPES.s
                  }
                  ...
                  function getTextareaInfo() {
                    ...
                    if (textareaCursorPosition !== undefined$1) {
                      var rowCols,
                        ...
                        cursorCol =
                          textareaCurrentCursorRowSplit[textareaCurrentCursorRowSplit[LEXICON.l] - 1][LEXICON.l]
                  ...
                  function nativeOverlayScrollbarsAreActive() {
                    return (
                      _ignoreOverlayScrollbarHidingCache && _nativeScrollbarIsOverlaid.x && _nativeScrollbarIsOverlaid.y
                    )
                  }
                ...
                return (
                  ...
                  (_plugin.defaultOptions = function (newDefaultOptions) {
                    ...
                    if (newDefaultOptions === undefined$1) return FRAMEWORK.extend(!0, {}, currDefaultOptions)
      ...
      var OverlayScrollbars = OverlayScrollbars$1.exports,
        OverlayScrollbarsComponent = function OverlayScrollbarsComponent(_a) {
          var _a$options = _a.options,
            ...
            rest = Object(_index_b45716e8_js__WEBPACK_IMPORTED_MODULE_22__.m)(_a, [
              'options',
              'extensions',
              'className',
              'children'
          ...
          return (
            ...
            Object(react__WEBPACK_IMPORTED_MODULE_23__.useEffect)(
              function () {
                OverlayScrollbars.valid(osInstance.current) && mergeHostClassNames(osInstance.current, className)
              },
              [className]
            ),
            react__WEBPACK_IMPORTED_MODULE_23___default.a.createElement(
              ...
              react__WEBPACK_IMPORTED_MODULE_23___default.a.createElement('div', { className: 'os-scrollbar-corner' })
            )
          )
        }
...
//# sourceMappingURL=10.cca49323.iframe.bundle.js.map
