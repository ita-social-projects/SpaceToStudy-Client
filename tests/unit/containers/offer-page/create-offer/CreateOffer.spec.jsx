...
describe('CreateOffer component', () => {
  ...
  it('should render correctly', async () => {
    const mainTitle = screen.getByText('offerPage.createOffer.title.main.tutor')
    const maintDescription = screen.getByText(
      'offerPage.createOffer.description.main.tutor'
    )
  ...
  it('should add and delete a language', () => {
    const languageInput = screen.getByLabelText(
      'offerPage.createOffer.labels.language'
    )
