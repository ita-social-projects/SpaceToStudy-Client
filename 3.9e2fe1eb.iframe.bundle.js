  ...
  [3],
  {
    './node_modules/@storybook/preview-web/dist/esm/renderDocs.js': function (
      ...
      var react = __webpack_require__('./node_modules/react/index.js'),
        ...
        wrapper = { fontSize: '14px', letterSpacing: '0.2px', margin: '10px 0' },
        ...
        NoDocs_NoDocs = function NoDocs() {
          return react_default.a.createElement(
            ...
            react_default.a.createElement(
              'div',
              { style: main },
              react_default.a.createElement('h1', { style: heading }, 'No Docs'),
              react_default.a.createElement(
                'p',
                null,
              ...
              react_default.a.createElement(
                'ul',
                null,
                react_default.a.createElement('li', null, 'Please check the story definition.'),
                react_default.a.createElement('li', null, 'Please check the Storybook config.'),
                react_default.a.createElement('li', null, 'Try reloading the page.')
              ),
              react_default.a.createElement(
                'p',
                null,
      ...
      function _renderDocsAsync() {
        return (_renderDocsAsync = _asyncToGenerator(
          regeneratorRuntime.mark(function _callee(story, docsContext, element) {
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              for (;;)
                switch ((_context.prev = _context.next)) {
                  case 0:
                    if (
                      !((null != (docs = story.parameters.docs) && docs.getPage) || (null != docs && docs.page)) ||
                  ...
                  case 3:
                    ...
                    return (
                      (_context.next = 7),
                      null === (_docs$getContainer = docs.getContainer) || void 0 === _docs$getContainer
                        ? void 0
                  ...
                  case 11:
                    ...
                    return (
                      (_context.next = 16),
                      null === (_docs$getPage = docs.getPage) || void 0 === _docs$getPage
                        ? void 0
                  ...
                  case 20:
                    return (
                      ...
                      new Promise(function (resolve) {
                        react_dom_default.a.render(docsElement, element, resolve)
                      })
                    )
                  case 24:
                  case 'end':
