...
interface RadioButtonInputsProps<T, U> extends Omit<RadioGroupProps, 'onChange'> {
...
const RadioButtonInputs = <T, U>({ onChange, items, value, title }: RadioButtonInputsProps<T, U>) => {
